...
//     version 1.11.2
//     from Assets/Samples/Input System PS5/0.3.0-preview/Multi Contoller PS5 Input Samples/Controls/GamepadControls.inputactions
//
...
namespace UnityEngine.InputSystem.PS5.ControllerSample
{
    ...
    ""controlSchemes"": [
        ...
        ~@GamepadControls()
        {
            UnityEngine.Debug.Assert(!m_Main.enabled, "This will cause a leak and performance issues, GamepadControls.Main.Disable() has not been called.");
        }
